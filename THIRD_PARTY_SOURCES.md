...
YoutubePull uses third-party helper executables. This document is intended to
...
When publishing a binary YoutubePull release, keep those files in the app
...
## YoutubePull source code

The Swift source code authored for YoutubePull is released under the MIT
...
2. Verify that `YoutubePull.app/Contents/Resources/THIRD_PARTY_NOTICES.txt`
   exists.
3. Verify that `YoutubePull.app/Contents/Resources/licenses/` contains the
...
6. Do not imply that YoutubePull is an official YouTube/Google product.
